  ...
  render() {
    return (
      <div>
        ...
        <p>This privacy policy sets out how “Roundabout” uses and protects any information that you give“Roundabout”when
          you use this website.</p>
        <p>“Roundabout” is committed to ensuring that your privacy is protected. Should we ask you to provide certain
        ...
        <p>“Roundabout” may change this policy from time to time by updating this page. You should check this page from
        ...
        <ul>We may collect the following information:
          ...
          <li>other information relevant to donor surveys</li>

        </ul>

        <p>What we do with the information we gather</p>
        <ul>We require this information to understand your needs and provide you with a better service, and in
          particular for the following reasons:
          <li>Internal record keeping.</li>
          <li>We may use the information to improve our services to charity.</li>
          <li>We may periodically send emails about events, special appeals or other information which we think you may
        ...
        <p>A cookie is a small file which asks permission to be placed on your computer’s hard drive. Once you agree,
        ...
        <p>We use traffic log cookies to identify which pages are being used. This helps us analyse data about webpage
        ...
        <p>We will not sell, distribute or lease your personal information to third parties unless we have your
          permission or are required by law to do so. We may use your personal information to send you information about
          third parties which we think you may find interesting if you tell us that you wish this to happen.</p>

        <p>You may request details of personal information which we hold about you under the Data Protection Act 1998. A
