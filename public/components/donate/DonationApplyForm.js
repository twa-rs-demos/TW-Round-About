    ...
    return (
      <div className="donation-apply-form">
        <div className="apply-form-header">
          <button><img className="close-btn" src="./public/images/home/close.png"/></button>
          ...
          <form>
            ...
            <div className="call-language">
              ...
              <div className="checkboxes">
                <p className="checkbox-item"><input type="checkbox" name="" value=""/>English</p>
                <p className="checkbox-item"><input type="checkbox" name="" value=""/>Chinese</p>
                <p className="checkbox-item"><input type="checkbox" name="" value=""/>Either</p>
              </div>
