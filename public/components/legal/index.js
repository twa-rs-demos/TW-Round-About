  ...
  render() {
    return (
      <div className='Legal'>
        ...
        <ul>
          <li className='li-item'>The content of the pages of this website is for your general information and use only.
            It is subject to
            change without notice.
          </li>
          <li className='li-item'>Neither we nor any third parties provide any warranty or guarantee as to the accuracy,
            timeliness,
          ...
          <li className='li-item'>Your use of any information or materials on this website is entirely at your own risk,
            for which we shall
            not be liable. It shall be your own responsibility to ensure that any products, services or information
            available through this website meet your specific requirements.
          </li>
          <li className='li-item'>This website contains material which is owned by or licensed to us. This material
            includes, but is not
          ...
          <li className='li-item'>All trade marks reproduced in this website which are not the property of, or licensed
            to, the operator are
            acknowledged on the website.
          </li>
          <li className='li-item'>Unauthorised use of this website may give rise to a claim for damages and/or be a
            criminal offence.
          </li>
          <li className='li-item'>From time to time this website may also include links to other websites. These links
          ...
          <li className='li-item'>You may not create a link to this website from another website or document without
            Roundabout’s prior
            written consent.
          </li>
          <li className='li-item'>Your use of this website and any dispute arising out of such use of the website is
        ...
        <p>Any redistribution or reproduction of part or all of the contents in any form is prohibited other than the
          following:</p>
        <ul>
          <li className='li-item'>you may print or download to a local hard disk extracts for your personal and
            non-commercial use only
          </li>
          <li className='li-item'>you may copy the content to individual third parties for their personal use, but only
            if you acknowledge
            the website as the source of the material
          </li>
          <li className='li-item'>You may not, except with our express written permission, distribute or commercially
            exploit the content.
