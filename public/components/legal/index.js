  ...
  render() {
    return (
      <div>
        ...
        <p>The term “Roundabout” or “us” or “we” refers to the owner of the website.</p>
        ...
        <ul>The use of this website is subject to the following terms of use:
          ...
          <li>You may not create a link to this website from another website or document without Roundabout’s prior
            written consent.
          </li>
        ...
        <p>This website and its content is copyright of Roundabout. All rights reserved.</p>
        <ul>Any redistribution or reproduction of part or all of the contents in any form is prohibited other than the
          following:
          <li>you may print or download to a local hard disk extracts for your personal and non-commercial use only</li>
          <li>you may copy the content to individual third parties for their personal use, but only if you acknowledge
            the website as the source of the material
          </li>
          <li>You may not, except with our express written permission, distribute or commercially exploit the content.
