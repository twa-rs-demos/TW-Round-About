        ...
        <div className="our-jods-icons container">
          <div className="row">
            ...
            <div className="col-lg-4">
              <a href="#">
                <img src="./public/images/our-work/icon_leukemia assistance_bg.png" alt="白血病救助"/><span
          ...
          <div className="row our-jobs-icons-second">
            ...
            <a href="#" className="col-md-3">
              <img src="./public/images/our-work/icon_medical assistance_bg.png" alt="灾区救助"/><span className="jod-text"
                                                                                                   id="disater-rescue-text">灾区救助</span>
            </a>

            <a href="#" className="col-md-4 col-lg-offset-1">
              <img src="./public/images/our-work/icon_community assistance_bg.png" alt="社区帮扶"/><span
