        ...
        <div className="jods-icons row">
          <div className="row">
            ...
            <div className="col-lg-4">
              <a href="#">
                <img src="./public/images/ourWork/icon_leukemia assistance_bg.png" alt="白血病救助"/><span
                className="jod-text">白血病救助</span>
              </a>
            </div>
            <a href="#" className="col-lg-3">
              <img src="./public/images/ourWork/icon_disaster relief_bg.png" alt="医疗救助"/><span className="jod-text">医疗救助</span>
            </a>
            <a href="#" className="col-lg-3 col-lg-offset-1">
              <img src="./public/images/ourWork/icon_education support_bg.png" alt="教育资助"/><span className="jod-text">教育资助</span>
            </a>
            <div className="col-lg-1"></div>
          </div>
          <div className="row our-jobs-icons-second">
            ...
            <a href="#" className="col-md-3">
              <img src="./public/images/ourWork/icon_medical assistance_bg.png" alt="灾区救助"/><span className="jod-text"
                                                                                                   id="disater-rescue-text">灾区救助</span>
            </a>

            <a href="#" className="col-md-4 col-lg-offset-1">
              <img src="./public/images/ourWork/icon_community assistance_bg.png" alt="社区帮扶"/><span
              className="jod-text" id="community-rescue-text">社区帮扶</span>
            </a>
